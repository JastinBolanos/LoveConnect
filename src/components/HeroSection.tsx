...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  const [, setIsHoveredMatch] = useState(false);
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-[#13082a] via-[#220c48] to-[#120826] text-white pt-8 pb-16 lg:pt-14 lg:pb-24">
      {/* Futuristic Background Ambient Glows and Cyber Gradients */}
      ...
      <div className="w-full px-4 sm:px-6 md:px-10 lg:px-14 xl:px-20 2xl:px-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-14 items-center">
          ...
          <div className="lg:col-span-5 xl:col-span-5 2xl:col-span-5 space-y-6 lg:space-y-7 text-left z-20">
            ...
            {/* Headline with animated pulsing neon heart outline and radiant glow */}
            <div className="space-y-1 relative animate-float">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                {/* Stylized Neon Pink Heart Outline with dynamic pulsing glow and rotation */}
            ...
            {/* Subtitle with relaxed typography */}
            ...
            {/* Stat Counters with Floating Animations and Pulsing Icons */}
            ...
            <div className="flex flex-wrap items-center gap-5 pt-2">
              ...
              >
                <div className="relative w-12 h-12 rounded-full border border-purple-400/50 bg-purple-950/70 flex items-center justify-center group-hover:scale-110 shadow-lg shadow-purple-900/50 transition-all duration-300">
                  {/* Radiating soundwave ripple rings */}
          ...
          {/* Right Hero Column: Expansive Couple Image with Floating Match & Review Cards */}
          <div className="lg:col-span-7 xl:col-span-7 2xl:col-span-7 relative flex items-center justify-center w-full">
            
            {/* Background cyber circle rings with heart pulses */}
            ...
            {/* Dotted connector trail from left to right */}
            ...
            {/* Couple Image Container - Clean, authentic portrait with warm sunset bokeh */}
            <div className="relative w-full aspect-[4/3] sm:aspect-[16/11] lg:aspect-[16/10] xl:aspect-[16/9.5] 2xl:aspect-[16/9] min-h-[420px] sm:min-h-[480px] lg:min-h-[520px] xl:min-h-[580px] rounded-[32px] overflow-hidden shadow-2xl shadow-pink-900/40 group">
              <img
                ...
                alt="Romantic couple smiling and embracing happily at sunset"
                className="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700"
                referrerPolicy="no-referrer"
              />

              {/* Romantic subtle edge gradients */}
            ...
            {/* Floating Card 1: "It's a Match! 🎉" (Top Right) */}
            <div 
              className="absolute top-4 right-4 sm:top-6 sm:right-6 xl:top-8 xl:right-8 z-20 w-64 sm:w-72 bg-white text-gray-900 rounded-2xl p-4 shadow-2xl shadow-pink-500/30 border border-white/60 animate-float transition-transform hover:scale-105"
